<template>
  <section class="bg-[#0D0D0D] text-[#F1FAEE] px-6 py-20 md:py-32">
    <div class="max-w-5xl mx-auto space-y-16">
      <div>
        <h2
          class="text-5xl md:text-7xl font-extrabold tracking-tight mb-10 text-[#00D8FF]"
        >
          FONT <span class="font-outline">FAMILY</span>
        </h2>
        <div class="flex flex-wrap items-center gap-8 text-lg md:text-xl">
