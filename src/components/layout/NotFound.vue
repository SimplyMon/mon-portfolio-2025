  ...
  >
    ...
    <div class="mb-6">
      <img
        ...
        alt="Waiting cartoon"
        class="w-48 h-48 animate-bounce-slow"
      />
    </div>
...
.animate-wait1 {
  animation: wait1 1.4s infinite ease-in-out;
  animation-delay: 0s;
}
.animate-wait2 {
  animation: wait2 1.4s infinite ease-in-out;
  animation-delay: 0.2s;
}
.animate-wait3 {
  animation: wait3 1.4s infinite ease-in-out;
